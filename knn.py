...
def knn_classifier(X_train, y_train, X_test, y_test):
    ...
    # Initialize KNeighborsClassifier with current parameters
    nb = KNeighborsClassifier()
    
    # Initialize GridSearchCV with the classifier and parameter grid
    grid_search = GridSearchCV(estimator=nb, param_grid=param_grid, scoring='roc_auc', cv=5, n_jobs=-1)
    ...
    # Initialize KNeighborsClassifier classifier with the best parameters
